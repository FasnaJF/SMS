$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'dash_bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'dash_css/bootstrap-' + themeName + '.min.css');
        }
...
function docReady() {
    ...
    $('#file_upload').uploadify({
        'swf': 'dash_misc/uploadify.swf',
        'uploader': 'dash_misc/uploadify.php'
